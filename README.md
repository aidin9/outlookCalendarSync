...
2. Click "New Project"
3. **View the code:** [Open Code.gs in read-only view](https://script.google.com/d/1n2n1WWzwdbbzotSjze6j9kSFx4t5PkcVrqcfQZYBk9IxzdtpiEg1LiN-/edit?usp=sharing)
4. Select all code (Ctrl+A / Cmd+A) and copy it
5. Paste it into your new Google Apps Script project
6. Save the project (give it a name like "Outlook Calendar Sync")
